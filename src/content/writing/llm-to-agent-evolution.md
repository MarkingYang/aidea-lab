---
title: 回望 LLM 诞生的九年：从 LLM 到 Agent
description: 从 ChatGPT、AutoGPT、Devin 到 DeepSeek-R1、Manus 与 Codex，沿 46 个历史节点，将里程碑事件与 LLM 到 Agent 的技术变化连起来。
