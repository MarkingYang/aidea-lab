---
title: AI 能力与交付边界（二）：用真实任务选择模型，而不是看一次演示
...
上一篇：[能力地图](/writing/llm-agent-capability-landscape-2026/)。

模型、任务和证据已经被放回同一张表。终篇继续追问：能力地图为什么必须以委托边界结束，而不能停在产品比较？

下一篇：[整体思考](/writing/ai-capability-boundary-synthesis/)。
